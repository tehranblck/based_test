...
export default function SearchAndHero({ featured }: { featured: BlogPost }) {
    return (
        <div>
            ...
            <div className="mt-6 rounded-2xl overflow-hidden bg-card ring-1 ring-border/60">
                ...
                <div className="p-6 sm:p-8">
                    ...
                    <h2 className="mt-2 text-2xl sm:text-3xl font-bold tracking-tight text-foreground">{featured.title}</h2>
